...
import com.orbes.articlesapp.repository.IncidentRepository;
...
public class IncidentServiceImpl implements IncidentService {
    ...
    public boolean valid(Incident incident){
        List<Incident> incidents = new ArrayList<>();
        incidentRepository.findByObservations(incident.getObservations())
        .iterator().forEachRemaining(incidents::add);
